...
- Sie können Formulare von Komponenten als Unterformulare in Host Projekten veröffentlichen. Das bedeutet vorallem, dass Sie Komponenten mit grafischen Objekten entwickeln können. Zum Beispiel basieren Widgets, die 4D liefert, auf dem Einsatz von Unterformularen in Komponenten.
