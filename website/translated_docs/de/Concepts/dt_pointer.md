...
$MyPointer:=->$MyVar
```
Das Symbol -> bedeutet "setze Zeiger auf". Es ist die Kombination aus einem Bindestrich und dem Zeichen “größer als”. In diesem Fall erhält sie den Zeiger, der auf $MyVar verweist bzw. zeigt. Dieser Zeiger wird mit dem Zuordnungsoperator dem Zeiger MyPointer zugewiesen.
