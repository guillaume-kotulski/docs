...
**Hinweis:** Arrays sind ein besonderer Variablentyp. Ein Array ist eine sortierte Reihe von Variablen desselben Typs. For more information, please refer to [Arrays](Concepts/arrays.md).
