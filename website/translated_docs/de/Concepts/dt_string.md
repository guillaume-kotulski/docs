...
```
> **Hinweise:** - 4D verwendet die ICU library zum Vergleichen von Strings (mit den Operatoren <>=#) und Suchen von Schlüsselwörtern. Weitere Informationen zu den Regeln bei Schlüsselwörtern finden Sie unter: http://www.unicode.org/unicode/reports/tr29/#Word_Boundaries. - In the Japanese version, instead of ICU, 4D uses Mecab by default for detecting keywords.
