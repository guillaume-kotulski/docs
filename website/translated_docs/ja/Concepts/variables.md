...
いったん作成された変数は、データベースで必要とされる場所に使用できます。 For example, you might need to store a text variable in a field of same type:
...
The assignment operator is a primary way to create a variable and to put data into it. 作成する変数名を代入演算子の左側に書きます。 たとえば:
