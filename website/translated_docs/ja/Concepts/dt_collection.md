...
4D collection references benefit from special methods (sometimes named *member functions*). オブジェクト記法によって、これらのメソッドは以下のシンタックスを使用することでコレクション参照に対して適用することが可能です:
...
Several methods accept a _propertyPath_ as parameter. この引数は以下のように用いることができます:
