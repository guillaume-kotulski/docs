...
| 名          | データタイプ     | とりうる値                                               |
| ---------- | ---------- | --------------------------------------------------- |
| choiceList | リスト、コレクション | A list of possible values                           |
| list       | リスト、コレクション | A list of possible values (hierarchical lists only) |
...
| 名      | データタイプ     | とりうる値                                    |
| ------ | ---------- | ---------------------------------------- |
| labels | リスト、コレクション | A list of values to fill the tab control |
