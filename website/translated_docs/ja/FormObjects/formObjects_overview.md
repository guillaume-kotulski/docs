...
* **[Form Editor](FormEditor/formEditor.md):** Drag an object from the Form Editor toolbar onto the form. フォームに配置したら、そのオブジェクトのプロパティをプロパティリストから編集できます。詳細については [フォームの作成](https://doc.4d.com/4Dv18/4D/18/Building-forms.200-4575447.ja.html) を参照ください。
